...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault();
      var statusMessege = document.createElement('div');
...
var showMoreStyles = function showMoreStyles(trigger, styeles) {
  var cards = document.querySelectorAll(styeles),
